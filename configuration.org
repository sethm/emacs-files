...
I like a standard editor size of 88 by 66 characters (If you know why, you win a cookie!)
This helper will set that size automatically.
...
#+BEGIN_SRC emacs-lisp
  (when (>= emacs-major-version 27)
    ...
    (set-face-attribute 'org-level-1 nil :family "Helvetica" :extend t :height 1.4 :underline t :weight 'bold)
    (set-face-attribute 'org-level-2 nil :family "Helvetica" :extend nil :height 1.2 :underline nil :weight 'bold)
    (set-face-attribute 'org-level-3 nil :family "Helvetica" :extend nil :underline nil :weight 'bold))
#+End_SRC
