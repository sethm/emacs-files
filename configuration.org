...
*** Fringe
    ...
    I waffle back and forth on whether I like fringe on my windows
    or not. Fringe is a little bit of space to the right and left,
    basically inner and outer margins. Some days I like it, some days
    I don't? Who can say. Anyway, for now, this turns it off.
...
** Company
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package company
       ...
       :defer t
       :custom
       (company-idle-delay 2.0) ;; how long to wait until popup
