...
*** Main Notes File
    ...
    My main Org Mode notes file can be opened with a simple shortcut.
...
*** Org Capture
    ...
    key binding of =C-c c=, and tell it what file I like to capture
    notes in.

    #+BEGIN_SRC emacs-lisp
      (global-set-key (kbd "C-c c") 'org-capture)
      (setq org-default-notes-file "~/ownCloud/Notes/notes.org")
    #+END_SRC
