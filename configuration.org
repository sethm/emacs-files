...
** Saving the Desktop
   ...
   This configuration allows the current emacs "desktop" (basically,
   the state of the frames and all the buffers) to be saved and
   reloaded automatically between sessions.
